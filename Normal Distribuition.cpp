...
void normal_distribution_pdf(const double m, const double s, const int samples) {    
    ...
    cout << "m. arit.: " << fixed << setw(11) << setprecision(10) << distr.mean() << endl;
    cout << "d. prd.: " << fixed << setw(11) << setprecision(10) << distr.stddev() << endl;
...
int main()
{
    ...
    cout << "Insira um valor numerico para a media aritmetica: " << endl;
    cin >> m_dist;
    cout << "Insira um valor numerico para o desvio padrao (deve ser maior que zero): " << endl;
    cin >> s_dist;
